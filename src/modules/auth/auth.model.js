...
class User {
  constructor(userId, username, email, password) {
    this.userId = userId; // Integer, auto-incremented
    this.username = username; // String, max length 70
    this.email = email; // String, max length 70
    this.password = password; // String, max length 200 (hashed)
  }
